...
export const ChatMessageSchema = new Map([
  [
    ChatMessage,
    {
      kind: "struct",
...
//   }
  ...
  async sendMessage(
    ...
    const scontractPubkey = new PublicKey(smart_contract_id);
    ...
    // const messageObj = new ChatMessage();
    // messageObj.archive_id = this.getTxIdFromArweave(arweaveid);
